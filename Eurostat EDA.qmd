...
The *White Test* also lets the independent variables to have a interactive and nonlinear effect on the error variance, and is a good tool as a safety measure @aroraAnswerWhatCriterion2016. This note was added due to the fact that we are actually looking at a theoretical nonlinear model, but through the transformation of data, we can still consider this as a linear model.
