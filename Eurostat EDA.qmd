...
The three regions with lowest GDP per capita is BG325 (Silistra), BG311 (Vidin) and BG342 (Silven) where BG325 and BG311 both are cities located north in Bulgaria, as shown in @tbl-3. BG342 is a larger city located more in the middle of Bulgaria a bit southeast [@StatisticalRegionsEuropean].
...
AT312 (Linz-Wels), AT130 (Wien) and AT323 (Salzburg) is the Regions with the highest scoring GDP per capita in 2010, as displayed by @tbl-6. They have held a similar pattern and GDP per capita from 2000 to 2020 [@StatisticalRegionsEuropean].
...
On the other side, the three regions with lowest GDP per capita by 2010 is HR034 (Šibensko-kninska županija), HR032 (Ličko-senjska županija) and HR035 (Splitsko-dalmatinska županija) shown in @tbl-9. All are located south in Croatia by the coast and boarders to Bosnia-Herzegovina [@StatisticalRegionsEuropean] .
