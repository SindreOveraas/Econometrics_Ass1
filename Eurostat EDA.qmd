...
GDP_Per_Capita %>% distinct(NUTS, Year, .keep_all = TRUE) %>%
  ggplot(aes(x = Year, y = GDP_capita, colour = NUTS)) + geom_line(lwd = .8) + labs(x = "Year", y = "GDP per capita") + theme_bw()
```
...
GDP_Per_Capita %>%
  ...
  ggplot(aes(x = Year, y = GDP_capita, colour = Region)) + geom_line(lwd = .8) + labs(x = "Year", y = "GDP per capita") + theme_bw()
```
...
GDP_Per_Capita %>%
  ...
  ggplot(aes(x = Year, y = GDP_capita, colour = Region)) + geom_line(lwd = .6) + labs(x = "Year", y = "GDP per capita") + theme_bw()
```
