...
In our case there is one coefficient of determination of our regression analysis in particular, that differs from the others.
...
```{r, echo=FALSE}
lm(GINI_NUTS2 ~ log_GDP_capita_NUTS2, data = Inequity_Data)
```
