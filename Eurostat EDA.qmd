...
in the model above we can see that its a big difference in GDP per capita in each region, ths can be caused by population or cluster with rich/poor individuals.

We also had som NA values witch we chose to take out of the dataset.
