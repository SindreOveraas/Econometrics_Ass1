...
From the model we can see that we have 4253 observations on each fixed effect and none of the Fixed effects are notable significant based on R squared
