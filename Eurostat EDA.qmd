...
BG342 is a larger city located more in the middle of Bulgaria a bit southeast.
...
Region BE100 includes the capital city of Belgium, Brussel [@brzozowskiBelgiumBreaks16month2020].
...
They have held a similar pattern and GDP per
capita from 2000 to 2020.
...
The graphs for Croatia shows that the financial crises also had an impact on the GDP per capita in 2008 until 2012/2013 before the GDP per capita startet do climb again
before it dips again around 2018.
We can see that region HR036 and HR031 has
GDP per capita that lays a bit higher than the other regions for the most part.

However, region HR037 and HR032 also had some good years.
Croatia has also
fewer regions with available DGP data on a nuts3 level then the other countries.
...
Dubrovnik-Neretva is the capital of Croatias and are also big on tourism, but
also makes a living out of hospitality industry, agriculture and maritime indisutry [@Economya].
...
Based on the statistics, we can note that the lowest coefficient is equal to 0, meaning that there are regions where inequity is absent.
We can also observe that the highest inequity throughout the entire period is 0.235.
...
To compare to our previous on the Gini coefficient to sub-national GDP, we have taken a closer look at the year 2010 as a measurement for the two
...
Based on the summary statistics, the density plot and the scatter plot, we can see noteable outliers.
This applies in particular to Bulgaria (BG), where there are some observations if the Gini coefficient above 0.2 up to 0.235.
This is noteworthy as only Bulgaria's coefficient is at this level.
